package com.denise.castro.e_commerce.ui.fragments.login
...
import com.denise.castro.e_commerce.ui.dialog.setupBottomSheetDialog
import com.denise.castro.e_commerce.util.Resource
import com.denise.castro.e_commerce.ui.viewmodel.LoginViewModel
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        lifecycleScope.launch {
            viewModel.login.collect {
                when(it) {
                    is Resource.Loading -> {
                        binding.buttonLoginLogin.setLoading()
                    }

                    is Resource.Success -> {
                        binding.buttonLoginLogin.setNormal()
